...
define_id!(PluginId);
define_id!(MigrationJobId);
define_id!(MigrationRunId);
define_id!(MigrationBatchId);
define_id!(MigrationSourceRecordId);
define_id!(MigrationStagedRecordId);
define_id!(MigrationFieldMappingId);
define_id!(MigrationValidationIssueId);
define_id!(MigrationDuplicateCandidateId);
define_id!(MigrationCheckpointId);
define_id!(MigrationImportResultId);
define_id!(MigrationExternalIdMapId);
